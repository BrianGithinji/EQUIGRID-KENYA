...
import { householdData, calculateEPI, classifyEPI, currentTariffs } from "../data/sampleData";
import { Play, RotateCcw, TrendingUp, TrendingDown, DollarSign, Users, Info } from "lucide-react";
...
export default function TariffSimulator() {
  ...
  // Calculate new tariff for a household
  const calculateNewElectricityCost = (consumption: number, region: string) => {
    let cost = 0;
    ...
    // Apply regional subsidy (reduce cost by percentage)
  ...
  const simulationResults = useMemo(() => {
    ...
    const results = householdData.map(hh => {
      const newCost = calculateNewElectricityCost(hh.consumption, hh.region);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-6 flex items-start gap-3">
          ...
          <div className="text-sm text-blue-900">
            <p>
              Adjust tariff parameters below to simulate policy changes. The system uses machine learning models
              to predict impacts on household affordability, utility revenue, and subsidy requirements.
            </p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-lg border border-gray-200 p-6">
              <h2 className="text-lg font-semibold text-gray-900 mb-4">Tariff Parameters</h2>
